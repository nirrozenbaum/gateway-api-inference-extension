...
//
// This function is called only with the relevant pods for the current request, and is assumed
// to be called with at least one pod. zero pods condition is checked before calling IsSaturated.
